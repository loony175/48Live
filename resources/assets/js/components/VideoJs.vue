                ...
                <div class="player-container">
                    ...
                    <Card>
                        ...
                        <div class="video-box">
                            ...
                            <video id="video-js" class="video" v-show="!isRadio"></video>

                            <PlayerControls ref="controls" :is-muted="isMuted"
                                            :show-progress="isReview"
                                            :show-play-button="isReview"
                                            :is-playing="isPlaying"
                                            :volume-disabled="volumeDisabled"
                                            @play="play" @pause="pause" @mute="mute"
                                            @unmute="unmute" @progress="progressChange"
